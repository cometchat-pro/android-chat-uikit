...
import com.cometchatworkspace.components.messages.message_list.message_bubble.CometChatMessageBubble;
...
public class MessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements StickyHeaderAdapter<MessageAdapter.DateItemHolder> {
    ...
    private final boolean isUserDetailVisible = false;
    ...
    private ShapeAppearanceModel leftMessageCornerRadius;
    private ShapeAppearanceModel rightMessageCornerRadius;
...
//        }
    ...
    private void setPollsData(PollMessageViewHolder viewHolder, int i) {
        ...
        BaseMessage baseMessage = messageList.get(i);
        viewHolder.cometChatPollBubble.backgroundColor(palette.getSecondary());
        viewHolder.cometChatPollBubble.questionColor(palette.getAccent());
        ...
        if (baseMessage != null) {
            ...
            if (!baseMessage.getSender().getUid().equals(loggedInUser.getUid())) {
                ...
                if (leftMessageCornerRadius != null)
                    viewHolder.cometChatMessageBubble.cornerRadius(leftMessageCornerRadius);
        ...
        viewHolder.cometChatPollBubble.setEventListener(new MessageBubbleListener() {
            @Override
        ...
        viewHolder.cometChatMessageBubble.replyCount(baseMessage.getReplyCount());
    }
...
//                        && !isLeftAligned) {
//                    viewHolder.cometChatMessageBubble.userNameVisibility(View.GONE);
//                    viewHolder.cometChatMessageBubble.avatarVisibility(View.GONE);
//                } else if (baseMessage.getReceiverType().equals(CometChatConstants.RECEIVER_TYPE_GROUP)) {
//                    if (isUserDetailVisible) {
//                        viewHolder.cometChatMessageBubble.userNameVisibility(View.VISIBLE);
//                        viewHolder.cometChatMessageBubble.avatarVisibility(View.VISIBLE);
//                    } else {
//                        viewHolder.cometChatMessageBubble.userNameVisibility(View.GONE);
//                        viewHolder.cometChatMessageBubble.avatarVisibility(View.INVISIBLE);
//                    }

//                    viewHolder.cometChatMessageBubble.avatar(baseMessage.getSender().getAvatar(),
//                            baseMessage.getSender().getName());
////                     setAvatar(viewHolder.ivUser, baseMessage.getSender().getAvatar(), baseMessage.getSender().getName());
//                    viewHolder.cometChatMessageBubble.userName(baseMessage.getSender().getName());
...
//                }
        ...
        viewHolder.cometChatMessageBubble.setMessageBubbleListener(new MessageBubbleListener() {
            @Override
            public void onLongCLick(BaseMessage baseMessage) {
                clearLongClickSelectedItem();
                isLongClickEnabled = true;
    ...
    private void setWriteBoardData(WriteBoardViewHolder viewHolder, int i) {
        ...
        if (baseMessage != null) {
            ...
            if (!baseMessage.getSender().getUid().equals(loggedInUser.getUid())) {
                ...
                viewHolder.documentMessageBubble.subtitle(baseMessage.getSender().getName() + " " +
                ...
                if (rightMessageCornerRadius != null)
                    viewHolder.cometChatMessageBubble.cornerRadius(rightMessageCornerRadius);
                viewHolder.documentMessageBubble.subtitle(context.getString(R.string.you_created_document));
            }
        }
    ...
    private void setWhiteBoardData(WhiteBoardViewHolder viewHolder, int i) {
        ...
        if (baseMessage != null) {
            ...
            if (!baseMessage.getSender().getUid().equals(loggedInUser.getUid())) {
                ...
                viewHolder.cometChatWhiteboardBubble.subTitle(baseMessage.getSender().getName() + " " +
                ...
                if (rightMessageCornerRadius != null)
                    viewHolder.cometChatMessageBubble.cornerRadius(rightMessageCornerRadius);
                viewHolder.cometChatWhiteboardBubble.subTitle(context.getString(R.string.you_created_whiteboard));
            }
        }
    ...
    private void setLocationData(LocationMessageViewHolder viewHolder, int i) {
        ...
        viewHolder.cometChatLocationBubble.setEventListener(new MessageBubbleListener() {
            @Override
            public void onLongCLick(BaseMessage baseMessage) {
                clearLongClickSelectedItem();
                isLongClickEnabled = true;
...
//                    mapIntent.setPackage("com.google.android.apps.maps");
    ...
    private void setAudioData(AudioMessageViewHolder viewHolder, int i) {
        if (isLeftAligned)
            viewHolder.cometChatMessageBubble.messageAlignment(Alignment.LEFT);
        BaseMessage baseMessage = messageList.get(i);
        viewHolder.cometChatAudioBubble.backgroundColor(palette.getSecondary());
...
//                context.startActivity(intent);
    ...
    private void setFileData(FileMessageViewHolder viewHolder, int i) {
        ...
        if (rightMessageCornerRadius != null)
            viewHolder.cometChatMessageBubble.cornerRadius(rightMessageCornerRadius);
        viewHolder.cometChatFileBubble.backgroundColor(palette.getSecondary());
        ...
        viewHolder.cometChatFileBubble.setEventListener(new MessageBubbleListener() {
            @Override
            public void onLongCLick(BaseMessage baseMessage) {
                clearLongClickSelectedItem();
                setLongClickSelectedItem(baseMessage);
            ...
            @Override
            public void onClick(BaseMessage baseMessage) {
                //TODO(Download and Preview File)
...
//            viewHolder.cometChatImageBubble.setImageUrl("data:image/png;base64,");
     ...
     * contents with CustomMessage at a given position.
     * It loads image from url available in CustomMessage.
     *
    ...
    private void setStickerData(StickerMessageViewHolder viewHolder, int i) {
        ...
        ((MaterialCardView) viewHolder.cometChatMessageBubble.getBubbleView())
                .setCardElevation(0);
        viewHolder.cometChatMessageBubble.replyCount(baseMessage.getReplyCount());
        viewHolder.cometChatMessageBubble.setMessageBubbleListener(new MessageBubbleListener() {
            @Override
    ...
    private void setDeleteData(DeleteMessageViewHolder viewHolder, int i) {
        BaseMessage baseMessage = messageList.get(i);
        viewHolder.cometChatTextBubble.setBackground(context.getDrawable(R.drawable.dotted_border));
        if (rightMessageRadius != -1)
            viewHolder.cometChatMessageBubble.cornerRadius(rightMessageRadius);
        if (rightMessageCornerRadius != null)
            viewHolder.cometChatMessageBubble.cornerRadius(rightMessageCornerRadius);
        ...
        if (baseMessage.getDeletedAt() != 0) {
            viewHolder.cometChatMessageBubble.replyCount(0);
            viewHolder.cometChatTextBubble.text(context.getString(R.string.this_message_deleted));
            viewHolder.cometChatTextBubble.textAppearance(typography.getText1());
...
////                viewHolder.tvUser.setText(baseMessage.getSender().getName());
    ...
    private void setTextData(TextMessageViewHolder viewHolder, int i) {
        ...
        if (baseMessage != null) {
            ...
            if (!baseMessage.getSender().getUid().equals(loggedInUser.getUid())) {
                ...
                if (leftMessageCornerRadius != null)
                    viewHolder.cometChatMessageBubble.cornerRadius(leftMessageCornerRadius);
                viewHolder.cometChatTextBubble.textColor(palette.getAccent());
                viewHolder.cometChatTextBubble.translateMessageColor(palette.getAccent());
                viewHolder.cometChatTextBubble.replyUserTextColor(context.getColor(R.color.colorPrimary));
                viewHolder.cometChatTextBubble.replyMessageTextColor(context.getColor(R.color.primaryTextColor));
            } else {
    ...
    private void setCustomData(CustomMessageViewHolder viewHolder, int i) {
        ...
        if (baseMessage != null) {
            ...
            if (!baseMessage.getSender().getUid().equals(loggedInUser.getUid())) {
                ...
                if (leftMessageCornerRadius != null)
                    viewHolder.cometChatMessageBubble.cornerRadius(leftMessageCornerRadius);
                viewHolder.customBubble.textColor(context.getColor(R.color.primaryTextColor));
            } else {
                setMessageBubbleInputData(viewHolder.cometChatMessageBubble, sentMessageInputData);
                viewHolder.customBubble.backgroundColor(palette.getPrimary());
                if (rightMessageRadius != -1)
                    viewHolder.cometChatMessageBubble.cornerRadius(rightMessageRadius);
                if (rightMessageCornerRadius != null)
                    viewHolder.cometChatMessageBubble.cornerRadius(rightMessageCornerRadius);
            }
            viewHolder.customBubble.text(context.getResources().getString(R.string.custom_message) + "(" + baseMessage.getType() + ")");
            viewHolder.customBubble.textFont(FontUtils.robotoLight);
    ...
    private void setLinkData(LinkMessageViewHolder viewHolder, int i) {
        if (isLeftAligned)
            viewHolder.cometChatMessageBubble.messageAlignment(Alignment.LEFT);
        BaseMessage baseMessage = messageList.get(i);
        viewHolder.cometChatMessageBubble.backgroundColor(context.getColor(R.color.colorPrimary));
        if (rightMessageRadius != -1)
            viewHolder.cometChatMessageBubble.cornerRadius(rightMessageRadius);
        if (rightMessageCornerRadius != null)
            viewHolder.cometChatMessageBubble.cornerRadius(rightMessageCornerRadius);
        if (baseMessage != null) {
            ...
            if (!baseMessage.getSender().getUid().equals(loggedInUser.getUid())) {
                ...
                if (leftMessageCornerRadius != null)
                    viewHolder.cometChatMessageBubble.cornerRadius(leftMessageCornerRadius);
                viewHolder.linkMessageBubble.titleColor(context.getColor(R.color.primaryTextColor));
                viewHolder.linkMessageBubble.subtitleColor(context.getColor(R.color.primaryTextColor));
                viewHolder.linkMessageBubble.buttonTextColor(context.getColor(R.color.colorPrimary));
            }

            viewHolder.cometChatMessageBubble.replyCount(baseMessage.getReplyCount());

            viewHolder.linkMessageBubble.setEventListener(new MessageBubbleListener() {
                @Override
                public void onLongCLick(BaseMessage baseMessage) {
                    isLongClickEnabled = true;
                    clearLongClickSelectedItem();
...
//        }
    ...
    private void setMessageBubbleInputData(CometChatMessageBubble bubble, MessageInputData messageInputData) {
    ...
    public void setMessageBubbleConfiguration(CometChatConfigurations configuration) {
        if (configuration instanceof MessageBubbleConfiguration) {
            MessageBubbleConfiguration config = (MessageBubbleConfiguration) configuration;
            if (config.getLeftMessageRadius() != -1)
                leftMessageRadius = config.getLeftMessageRadius();
            if (config.getLeftMessageCornerRadius() != null)
                leftMessageCornerRadius = config.getLeftMessageCornerRadius();
            if (config.getRightMessageRadius() != -1)
                rightMessageRadius = config.getRightMessageRadius();
            if (config.getRightMessageCornerRadius() != null)
                rightMessageCornerRadius = config.getRightMessageCornerRadius();
            if (config.getAvatarConfiguration() != null)
                avatarConfig = config.getAvatarConfiguration();
    ...
    class ImageMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public CometChatImageBubble cometChatImageBubble;
        ...
        public ImageMessageViewHolder(@NonNull View view) {
            ...
            cometChatMessageBubble = view.findViewById(R.id.cometchatBubble);
        }
    }
    ...
    class VideoMessageViewHolder extends RecyclerView.ViewHolder {
        public CometChatMessageBubble cometChatMessageBubble;
        public CometChatVideoBubble cometChatVideoBubble;
    ...
    public class FileMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        FileMessageViewHolder(@NonNull View itemView) {
            super(itemView);
            cometChatMessageBubble = itemView.findViewById(R.id.cometchatBubble);
    ...
    public class DeleteMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        public CometChatMessageBubble cometChatMessageBubble;
        public CometChatTextBubble cometChatTextBubble;
    ...
    public class CustomMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        CustomMessageViewHolder(@NonNull View view) {
            ...
            type = (int) view.getTag();
            cometChatMessageBubble = view.findViewById(R.id.cometchatBubble);
            customBubble = view.findViewById(R.id.custom_message);
        }
    }
    ...
    public class WriteBoardViewHolder extends RecyclerView.ViewHolder {
        ...
        private final int type;
        public CometChatMessageBubble cometChatMessageBubble;
        public CometChatDocumentBubble documentMessageBubble;
    ...
    public class LinkMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        private final View view;
        private final int type;
        public CometChatTextBubble linkMessageBubble;
        public CometChatMessageBubble cometChatMessageBubble;
