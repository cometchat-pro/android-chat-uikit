package com.cometchatworkspace.components.messages.composer.audioVisualizer;
...
public class AudioRecordView extends View {
    ...
    private final ArrayList<Float> chunkHeights = new ArrayList();
    private final ArrayList<Float> chunkWidths = new ArrayList<>();
    private final float topBottomPadding = Utils.dpToPixel(6,getResources());
