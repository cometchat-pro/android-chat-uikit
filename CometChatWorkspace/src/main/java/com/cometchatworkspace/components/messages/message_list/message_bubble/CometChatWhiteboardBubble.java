...
public class CometChatWhiteboardBubble extends RelativeLayout {
    ...
    private void initComponent(Context context, AttributeSet attributeSet) {
        ...
        alignment = Alignment.getValue(a.getInt(R.styleable.WhiteboardMessageBubble_messageAlignment,0));
        ...
        if (alignment== Alignment.LEFT)
            view = LayoutInflater.from(getContext()).inflate(R.layout.message_left_whiteboard_bubble,null);
        else
...
//        dataView = messageTemplate.getDataView();
    ...
    public void setButtonIconGravity(int gravity) {
        if (joinBtn!=null)
