...
public class CometChatCalls extends RecyclerView {
    ...
    private CometChatCallsViewModel callViewModel;

    public CometChatCalls(@NonNull Context context) {
        super(context);
        this.context=context;
        setViewModel();
    }

    public CometChatCalls(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context=context;
        setViewModel();
    }

    public CometChatCalls(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void setViewModel(){
        if (callViewModel==null)
            callViewModel=new CometChatCallsViewModel(context,this);
    ...
    public void setItemClickListener(OnItemClickListener<Call> onItemClickListener){
        ...
        this.addOnItemTouchListener(new RecyclerTouchListener(context, this, new ClickListener() {
            ...
            public void onClick(View var1, int var2) {
                ...
                var1.findViewById(R.id.callListItem_userDetails).setOnClickListener(new OnClickListener() {
                    @Override
    ...
    public void setItemCallClickListener(OnItemClickListener<Call> onItemClickListener){
        ...
        this.addOnItemTouchListener(new RecyclerTouchListener(context, this, new ClickListener() {
            ...
            public void onClick(View var1, int var2) {
                ...
                var1.findViewById(R.id.callListItem_button).setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
