...
//            resultList.add(reaction);
    ...
    public static void setupReaction(Context context,int count, LinearLayout reactionsLayout, OnReactionClickListener clickListener) {
        List<Reaction> reactions = Extensions.getInitialReactions(count);
        for (Reaction reaction : reactions) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    clickListener.onEmojiClicked(reaction);
                }
            });
        }
        ...
        addEmojiView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                clickListener.onEmojiClicked(new Reaction("add_emoji", 0));
