package com.cometchatworkspace.components.shared.secondaryComponents.cometchatSharedMedia.adapter;
...
public class CometChatSharedMediaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<BaseMessage> messageArrayList = new ArrayList<>();
