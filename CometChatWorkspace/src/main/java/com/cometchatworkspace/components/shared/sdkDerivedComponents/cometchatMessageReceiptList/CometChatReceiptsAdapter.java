package com.cometchatworkspace.components.shared.sdkDerivedComponents.cometchatMessageReceiptList;
...
public class CometChatReceiptsAdapter extends RecyclerView.Adapter<CometChatReceiptsAdapter.ReceiptsHolder> {
    ...
    private final List<MessageReceipt> messageReceiptList = new ArrayList<>();
    private final String loggedInUserUid = CometChat.getLoggedInUser().getUid();
