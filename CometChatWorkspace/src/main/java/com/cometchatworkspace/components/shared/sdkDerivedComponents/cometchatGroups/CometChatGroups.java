...
public class CometChatGroups extends RecyclerView {
    ...
    public CometChatGroups(@NonNull Context context) {
        super(context);
    ...
    public CometChatGroups(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        getAttributes(attrs);
        this.context=context;
        setViewModel();
    ...
    public CometChatGroups(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public void setItemClickListener(OnItemClickListener<Group> onItemClickListener){
        ...
        this.addOnItemTouchListener(new RecyclerTouchListener(context, this, new ClickListener() {
            ...
            public void onClick(View var1, int var2) {
                ...
                if (onItemClickListener!=null && group!=null)
