...
class TemplateAdapter extends RecyclerView.Adapter<TemplateAdapter.myViewHolder> {
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        ...
        optionAdapter = new OptionAdapter(context, user, group, cometChatDetailsTemplate.getId(), defaultOnDetailOptionClick, layoutManager);
