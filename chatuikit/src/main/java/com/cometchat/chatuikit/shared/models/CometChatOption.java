...
/**
 * The CometChatOption class represents an option that can be displayed in a Uikit.
 * <p>
 * It encapsulates properties such as the option's ID, title, icon, colors, appearance, and click listener.
 */
public class CometChatOption {
    ...
    /**
     * Constructs a new instance of CometChatOption with the specified ID, title, and icon.
     *
    ...
    /**
     * Constructs a new instance of CometChatOption with the specified ID, title, icon, and click listener.
     *
     * @param id      the unique identifier of the option
     * @param title   the title of the option
     * @param icon    the icon resource of the option
