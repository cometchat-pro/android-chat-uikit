...
// execute this when the downloader must be fired
    ...
    public static void downloadFileFromUrl(Context context, String fileUrl,String fileName, String action) {
    ...
    private static void shareFile(Context context, String file) {
        try {
            Intent shareIntent = new Intent();
            shareIntent.setAction(Intent.ACTION_SEND);
            shareIntent.putExtra(Intent.EXTRA_STREAM, FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".provider", new File(file)));
