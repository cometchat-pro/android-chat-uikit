...
/**
 * CometChatDetailsOption is a class representing an option for displaying details option  in Details component.
 * <p>
 * It extends the CometChatOption class.
 * <pre>
 * {@code
 * //CometChatDetailsOption class has total of  3 constructor
 * //1st CometChatDetailsOption(String id, String title, @DrawableRes int startIcon, @DrawableRes int endIcon, OnDetailOptionClick onClick)
 * CometChatDetailsOption option=new CometChatDetailsOption("id1", "Title", R.drawable.icon, R.drawable.icon, new OnDetailOptionClick() { @Override
 *             public void onClick(User user, Group group, String templateId, CometChatDetailsOption option, Context context) {
 *
 *             }
 *         });
 *
 * //2nd CometChatDetailsOption(String id, String title, int startIcon, int endIcon, int titleColor, String titleFont, int titleAppearance, int startIconTint, int endIconTint, OnDetailOptionClick onClick)
 * CometChatDetailsOption option =  new CometChatDetailsOption(UIKitConstants.UserOption.VIEW_PROFILE, getString(R.string.title), R.drawable.start_icon, R.drawable.end_icon, getResources().getColor(R.color.black), null, R.style.Name, 0, getResources().getColor(R.color.black), new OnDetailOptionClick() { @Override
 *            public void onClick(User user, Group group, String templateId, CometChatDetailsOption option, Context context) {
 *
 *            }
 *        });
 * //3rd CometChatDetailsOption(Function3< Context, User, Group, View> view, OnDetailOptionClick onClick)
 * CometChatDetailsOption option = new CometChatDetailsOption(new Function3<Context, User, Group, View>() { @Override
 ...
 *                 return textView;
 *             }
 *         }, new OnDetailOptionClick() { @Override
 *             public void onClick(User user, Group group, String templateId, CometChatDetailsOption option, Context context) {
 *
 *             }
 *         });
...
public class CometChatDetailsOption extends CometChatOption {
    ...
    private OnDetailOptionClick onClick;
    private @ColorInt
    int titleColor;
    ...
    /**
     * Returns the custom view for the option based on the provided context, user, and group.
     *
