...
/**
 * CometChatDetailsTemplate is a class representing a template for displaying details in CometChat.
 * It provides customizable options for configuring the appearance and behavior of the details template.
 * The template includes a unique identifier, a title, font settings, colors, and separator options.
 * It also allows defining a function to generate a list of CometChatDetailsOption objects based on user and group data.
 * Use the various setter methods to configure the template and retrieve the configured values using the getter methods.
 * The template can be used to create consistent and visually appealing details views.
 * <br>
 * example :
 * <pre>{@code
 * CometChatDetailsTemplate template = new CometChatDetailsTemplate()
 *                 .setId("id")
 *                 .setOptions((user, group) -> {
 *                     List<CometChatDetailsOption> detailsOptions = new ArrayList<>();
 *                     return detailsOptions;
 *                 })
 *                 .setTitle("title")
 *                 .setTitleColor(getResources().getColor(R.color.red))
 *                 .setTitleAppearance(R.style.Name)
 *                 .setSectionSeparatorColor(getResources().getColor(R.color.black))
 *                 .hideSectionSeparator(false)
 *                 .setItemSeparatorColor(getResources().getColor(R.color.blue))
...
public class CometChatDetailsTemplate {
    ...
    /**
     * Sets the options function for generating a list of CometChatDetailsOption objects.
     *
    ...
    /**
     * Generates a list of CometChatDetailsOption objects based on the provided user and group.
     *
