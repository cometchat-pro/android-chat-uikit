...
/**
 * Custom implementation of a CometChat button that extends the MaterialCardView class.
 * <p>
 * This button provides various customization options for styling and appearance.
 */
public class CometChatButton extends MaterialCardView {
    ...
    /**
     * Constructs a CometChatButton object with the given context, attributes, and default style.
     *
     * @param context      The context in which the button is created.
     * @param attrs        The attributes of the XML tag that is inflating the button.
    ...
    /**
     * Initializes the CometChatButton by inflating the layout and initializing its components.
     *
     * @param context The context in which the button is created.
     */
    ...
    public void setButtonTextFont(String fonts) {
        if (fonts != null && !fonts.isEmpty())
            buttonText.setTypeface(FontUtils.getInstance(context).getTypeFace(fonts));
    }
    ...
    public void setButtonTextAppearance(int appearance) {
        if (buttonText != null && appearance != 0)
            buttonText.setTextAppearance(context, appearance);
    }
     ...
     */
    public void setButtonText(String titleStr) {
     ...
     *
     * @param hide Boolean indicating whether to hide the button icon (true) or show it (false).
     */
     ...
     *
     * @param hideText Boolean indicating whether to hide the button text (true) or show it (false).
     */
     ...
     *
     * @param hide Boolean indicating whether to hide the button background (true) or show it (false).
     */
     ...
     *
     * @param style The ButtonStyle object containing the style properties to be applied.
     * @see ButtonStyle
     */
