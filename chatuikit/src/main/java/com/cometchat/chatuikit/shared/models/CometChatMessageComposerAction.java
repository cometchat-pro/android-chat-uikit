...
/**
 * CometChatMessageComposerAction is a class representing an action item in the message composer of CometChat.
 * It encapsulates the properties and behavior of a message composer action, such as an icon, title, colors, and click behavior.
 * The action can be configured with various properties using the setter methods provided.
 * Use the getter methods to retrieve the configured properties of the action.
 * This class is typically used in conjunction with the CometChatMessageComposer to define custom actions that can be displayed in the message composer UI.
 * <br>
 * example:
 * <pre>
 * {@code
