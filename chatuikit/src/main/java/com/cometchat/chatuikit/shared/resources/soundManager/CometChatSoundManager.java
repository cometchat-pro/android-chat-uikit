...
/**
 ...
 The CometChatSoundManager class handles audio-related functionality in the CometChat SDK.

 It provides methods for playing different types of sounds and managing audio settings.
 */
