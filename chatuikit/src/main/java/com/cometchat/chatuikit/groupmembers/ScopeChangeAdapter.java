...
public class ScopeChangeAdapter extends ArrayAdapter<String> {
    ...
    public ScopeChangeAdapter(@NonNull Context context, @NonNull GroupMember groupMember, Group group, @NonNull List<String> options) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        scope.setTextAppearance(context, typography.getText3());
        if (title != null)
            scope.setText(title);
        return convertView;
    }
    ...
    private void disableItem(LinearLayout item_bg, TextView scope) {
